...
col1, col2, col3 = st.columns((.5,1.7,1.3))

with col1:
    col1.subheader("Legend")
    source3 = Image.open("MapLegend.png")
...
#    "                                                "
#    "                                                "
#    col1.image(source1, use_column_width=False)
...
with col2:
    ...
    source4 = Image.open("Metrics.png")
    col2.image(source4, use_column_width=False)    
    
with col3:
    "   "
    "   "
    col3.subheader("NO2 MEASUREMENT EVOLUTION TODAY")
    source1 = Image.open("BoxPlot.png")
    col3.image(source1, use_column_width=True)
